...
const char* ssid     = "SSID";   // El SSID de tu red
const char* password = "PASSWORD";   // Tu contraseña de red
...
int waitingTime = 30000; // Espera 30 segundos a la respuesta de google.
...
#define TIME_TO_SLEEP  120  /* Tiempo en minutos de sleep */
